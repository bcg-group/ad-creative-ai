    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4">
      <div className="bg-white rounded-2xl border border-gray-200 p-8 w-full max-w-sm shadow-sm">
        <div className="flex items-center gap-3 mb-8">
          ...
          <div>
            <h1 className="text-lg font-semibold text-gray-900 leading-tight">Ad Creative AI</h1>
            <p className="text-xs text-gray-400">for mobile apps</p>
          </div>
        </div>

        <h2 className="text-xl font-semibold text-gray-900 mb-1">Get started</h2>
        <p className="text-sm text-gray-500 mb-6">
          Generate Meta, TikTok &amp; Google UAC ad copy in seconds.
        </p>
